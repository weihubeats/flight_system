...
<body>
	...
	<div class="container-fluid">
		...
		<div>
			<ul class="nav navbar-nav">
				<li class="active"><a href="flight/selectpage.json">查看航班信息</a></li>
	...
	<br/><br/><br/>
	<form action="flight/update.json">
	<table class="table table-hover">
		...
		<tbody>
				<tr>
					<td><input type = "text" readonly ="true" name = "flightid" value="${param.flightid}"></td>
					<td>
					<div class="form">
							<select id="flighname" class="select" name="flighname">
								<option value="请选择航空公司 ">请选择航空公司&nbsp;&nbsp;</option>
					...
					<td><input type="text" value="${param.startTime}" name="startTime"></td>
				</tr>
		</tbody>
				<thead>
				<tr>
				...
				<tbody>
				<tr>
					<td><input type="text" value="${param.arrivalTime}" name = "arrivalTime"></td>
					<td><input type="text" value="${param.price}" name="price"></td>
					<td><input type="text" value="${param.ticket}" name= "ticket"></td>
					<td>
					<div class="form">
					...
					<td><input type = "text" style="visibility:hidden" name = "page" value="${param.page}"></td>
...
<script type="text/javascript">
document.getElementById("city").value = ${param.punctuality};
document.getElementById("flighname").value = '${param.flighname}';
document.getElementById("startCity").value = '${param.startCity}';
document.getElementById("arrivalCity").value = '${param.arrivalCity}';
</script>
